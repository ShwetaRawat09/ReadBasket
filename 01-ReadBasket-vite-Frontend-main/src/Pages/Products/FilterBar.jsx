...
export const FilterBar = ({ setShow }) => {
  //dispatch is a function to update state
  ...
  return (
    <section className="filter">
      <div
        ...
        className={`fixed z-40 h-screen p-5 overflow-y-auto bg-white w-72 border-t-2 border-gray-100 dark:bg-gray-800 transition-transhtmlForm left-0 top-16 transhtmlForm-none `}
        tabIndex="-1"
      ...
      >
        <h5
          ...
          className="text-base font-semibold text-gray-500 uppercase dark:text-gray-100"
        >
          Filters
        </h5>
        <button
          ...
          <ul className="text-slate-700 dark:text-slate-100">
            ...
            <li className="mt-1 mb-5 px-1">
              <button
                ...
                type="button"
                className="text-gray-900 bg-green-500 hover:bg-green-600 border border-gray-300 focus:outline-none hover:bg-gray- focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-gray-300 dark:text-black dark:border-gray-800 dark:hover:bg-gray-200 dark:hover:border-gray-600 dark:focus:ring-gray-700"
              >
                Clear Filter
              </button>
            </li>
