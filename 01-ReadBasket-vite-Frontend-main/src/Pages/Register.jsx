...
import { register } from '../Services/ServiceIndex';
...
export const Register = () => {
  ...
  async function handleRegister(event){
    ...
    try{
      ...
      const data = await register(authDetail); //This will generate a token
