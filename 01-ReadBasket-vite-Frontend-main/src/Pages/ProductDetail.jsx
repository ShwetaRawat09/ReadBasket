...
import { Rating } from "../Components/CompIndex";
import { useCart } from "../Context/ContextIndex";
import { getProduct } from "../Services/ServiceIndex";
...
export const ProductDetail = () => {
  ...
  const { id } = useParams(); //to fetch ID 

  useTitle(product.name); // [Important]
  
  //API to fetch Product Data from backend
  useEffect(() => {
